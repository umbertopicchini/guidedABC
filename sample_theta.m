...
switch type_margin
    ...
    case 4
        ...
        for i=1:dim
             ...
             % notice the MATLAB parameterization of the Gumble distribution is slightly different from the canonical one found eg in R or Wikipedia (below we use bet instead of -bet)
